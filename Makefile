...
obj_MathUtils = Geometry.o Integrator.o MiscUtils.o RefCounter.o analysis.o linmin.o InterpolationHelper.o

obj_FieldSource = FieldSource.o MixedSource.o InfiniteLineSource.o LineSource.o InfinitePlaneSource.o SurfaceSource.o \
	PlanarElement.o PlaneSource.o FieldEstimator2D.o

obj_Solver = ReactiveSet.o InterpolatingRS.o GenericSolver.o InteractionSolver.o SymmetricSolver.o
